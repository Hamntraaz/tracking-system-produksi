  ...
  return (
    <>
      <section className="role-hero admin-hero">
        <div><span className="eyebrow light">Admin Gudang/Cabang</span><h2>Kontrol stok dan pengadaan bahan baku.</h2><p>Data di halaman ini dibaca dari database MySQL melalui backend API.</p></div>
      </section>
