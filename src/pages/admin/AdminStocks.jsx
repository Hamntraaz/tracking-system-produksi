...
export default function AdminStocks({ data = {}, refreshData }) {
  ...
  return (
    <>
      <section className="page-head-card"><div><span>Admin Gudang/Cabang</span><h2>Stok Bahan Baku</h2><p>Kelola bahan baku, stok minimum, dan lihat riwayat stok masuk/keluar.</p></div></section>
